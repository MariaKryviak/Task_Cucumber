...
import com.kryviak.decorator.elements.ButtonDecor;
import com.kryviak.decorator.elements.InputTextDecor;
import com.kryviak.decorator.elements.LinkDecor;
...
public class MailboxPage extends AbstractPage {
    ...
    public void selectMessageByTitle(String msgTitle) {
        ...
        waitForElementIsNotVisible(undoLinkLocator);
        getAllMessages.get(1).isDisplayed();
